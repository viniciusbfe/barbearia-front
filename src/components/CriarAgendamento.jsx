        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              disabled={isEdicao} // 👈
              className={`w-full p-4 rounded-2xl bg-gray-800 border border-gray-700 text-white outline-none focus:border-purple-500 transition ${isEdicao ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                }`}
            >
